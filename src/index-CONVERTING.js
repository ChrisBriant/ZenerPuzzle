...
//import MainGame from './index-WITHCLASSES.js';
...
var MainGame =  new Phaser.Class({
  ...
  create: function() {
    ...
    floor = this.add.tileSprite(400, 585, 800, 30, "block30x30");
    ground.add(floor);
    ...
    farleftwall = this.physics.add.staticGroup();
...
const config = {
  ...
  width: 800,
  height: 600,
  //scene: [ StartScreen, { preload: preload, create: create, update: update } ]
